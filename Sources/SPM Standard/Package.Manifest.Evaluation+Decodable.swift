...
// rejected rather than guessed.
  ...
  extension Package.Manifest.Evaluation: Decodable {
    ...
    public init(from decoder: any Decoder) throws {
      ...
      let toolsWire = try container.decode(
        Package.Manifest._ToolsVersionWire.self, forKey: .toolsVersion
      )
      ...
      let wireDependencies = try container.decode(
        [Package.Manifest.Evaluation._DependencyWire].self, forKey: .dependencies
      )
      ...
      let products =
        try container.decodeIfPresent(
          [Package.Manifest.Product].self, forKey: .products
        ) ?? []
      let targets =
        try container.decodeIfPresent(
          [Package.Manifest.Target].self, forKey: .targets
        ) ?? []
  ...
  extension Package.Manifest.Evaluation {
    ...
    internal static func _exactlyOne<Element>(
      _ array: [Element]?, _ label: Swift.String
    ...
    internal static func _identity(
      _ token: Swift.String, _ label: Swift.String
    ...
    internal static func _requirement(
      _ wire: Package.Manifest._RequirementWire, _ label: Swift.String
