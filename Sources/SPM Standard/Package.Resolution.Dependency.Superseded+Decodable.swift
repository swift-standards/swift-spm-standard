...
// record carries one inside another, which is why this type is not recursive.
  ...
  extension Package.Resolution.Dependency.Superseded: Decodable {
    ...
    public init(from decoder: any Decoder) throws {
      ...
      self.init(
        reference: try container.decode(Package.Resolution.Reference.self, forKey: .packageRef),
        checkout: try state.decode(Package.Resolution.Checkout.self, forKey: .checkoutState),
