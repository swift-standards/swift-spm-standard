    ...
    extension Package.Requirement: Codable {
        ...
        public init(from decoder: any Decoder) throws {
            ...
            case .range:
                ...
                let lowerBound: Version.Range<Version.Semantic>.Bound = lowerInclusive
                    ? .inclusive(lower) : .exclusive(lower)
                let upperBound: Version.Range<Version.Semantic>.Bound = upperInclusive
        ...
        public func encode(to encoder: any Encoder) throws {
            ...
            case .range(let range):
                ...
                try Self.encodeBound(range.lowerBound, into: &container, value: .lower, flag: .lowerInclusive)
                try Self.encodeBound(range.upperBound, into: &container, value: .upper, flag: .upperInclusive)
